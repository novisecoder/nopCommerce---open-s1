...
<div class="section-header">
    <div class="title">
        <img src="Common/ico-configuration.png" alt="<%=GetLocaleResourceString("Admin.Countries.ManageCountries")%>" />
        <%=GetLocaleResourceString("Admin.Countries.ManageCountries")%>
    </div>
    <div class="options">
