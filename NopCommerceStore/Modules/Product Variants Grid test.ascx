<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Product Variants Grid test.ascx.cs" Inherits="NopSolutions.NopCommerce.Web.Modules.Product_Variants_Grid_test" %>
    ...
    <asp:Repeater ID="rptVariants" runat="server" OnItemCommand="rptVariants_OnItemCommand"
        ...
        <ItemTemplate>
            <div class="product-variant-line">
                ...
                <nopCommerce:TierPrices ID="ctrlTierPrices" runat="server" ProductVariantId='<%#Eval("ProductVariantId") %>'></nopCommerce:TierPrices>
                <div class="clear">
                </div>
                <div class="attributes">
                    <nopCommerce:ProductAttributes ID="ctrlProductAttributes" runat="server" ProductVariantId='<%#Eval("ProductVariantId") %>'></nopCommerce:ProductAttributes>
                </div>
                <div class="clear">
                </div>
                ...
                <div class="add-info">
                    ...
                    <asp:Button ID="btnAddToCart" runat="server" Text="<% $NopResources:Products.AddToCart %>"
                        CommandName="AddToCart" CommandArgument='<%#Eval("ProductVariantId")%>' CssClass="productvariantaddtocartbutton"></asp:Button>
                    <asp:Button ID="btnAddToWishlist" runat="server" Text="<% $NopResources:Wishlist.AddToWishlist %>"
                        CommandName="AddToWishlist" CommandArgument='<%#Eval("ProductVariantId")%>' CssClass="productvariantaddtowishlistbutton"></asp:Button>
                </div>
                <div class="clear">
                </div>
