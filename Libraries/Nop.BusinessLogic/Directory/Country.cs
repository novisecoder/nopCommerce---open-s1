...
namespace NopSolutions.NopCommerce.BusinessLogic.Directory
{
    ...
    public partial class Country : BaseEntity
    {
        ...
        /// Gets the Country
        /// </summary>
        public List<CountryVariant> CountryVariants
        {
            get
            {
                return IoC.Resolve<ICountryService>().GetCountryVariantsByCountryId(this.CountryId);
            }
        }
        ...
        public bool HasMultipleVariants
        {
            get
            {
                return (CountryVariants.Count > 1);
            }
        }
        ...
        public CountryVariant ListCountries
        {
            get
            {
                var countryVariants = this.CountryVariants;
                countryVariants.Sort(new GenericComparer<CountryVariant>
                ("Id", GenericComparer<CountryVariant>.SortOrder.Ascending));
                if (countryVariants.Count > 0)
                    return countryVariants[0];
                else return null;
            }
        }
        ...
        public virtual ICollection<CountryVariant> NpCountryVariants { get; set; }
