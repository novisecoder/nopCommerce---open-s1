...
namespace NopSolutions.NopCommerce.BusinessLogic.Directory
{
    ...
    public partial class CountryService : ICountryService
    {
        ...
        public List<CountryVariant> GetAllCountryVariants(int countryId, string keywords, int pageSize, int pageIndex, out int totalRecords)
        {
            throw new NotImplementedException();
        }

        public CountryVariant GetCountryVariantById(int countryVariantId)
        {
            throw new NotImplementedException();
        }

        public List<CountryVariantLocalized> GetCountryVariantLocalizedByCountryVariantId(int countryVariantId)
        {
            throw new NotImplementedException();
        }

        public CountryVariantLocalized GetCountryVariantLocalizedByCountryVariantIdAndLanguageId(int countryVariantId, int languageId)
        {
            throw new NotImplementedException();
        }

        public List<CountryVariant> GetCountryVariantsByCountryId(int countryId)
        {
            throw new NotImplementedException();
        }
